...
module: verifactu
screen: certificate
route: /settings/verifactu/certificate
related_endpoints:
...
_Screen `/settings/verifactu/certificate` of the `verifactu` module._
