...
module: verifactu
screen: vat-mapping
route: /settings/verifactu/vat-mapping
related_endpoints:
...
# /settings/verifactu/vat-mapping

> _Scaffolded stub — replace with proper documentation when this module is next touched._

_Screen `/settings/verifactu/vat-mapping` of the `verifactu` module._
