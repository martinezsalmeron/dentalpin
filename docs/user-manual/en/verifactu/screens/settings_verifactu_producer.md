...
module: verifactu
screen: producer
route: /settings/verifactu/producer
related_endpoints:
...
# /settings/verifactu/producer

> _Scaffolded stub — replace with proper documentation when this module is next touched._

_Screen `/settings/verifactu/producer` of the `verifactu` module._
