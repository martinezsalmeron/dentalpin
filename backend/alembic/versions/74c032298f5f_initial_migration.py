...
def upgrade() -> None:
    ...
    op.create_index('idx_appointment_slot', 'appointments', ['clinic_id', 'cabinet', 'professional_id', 'start_time'], unique=True, postgresql_where=sa.text("status != 'cancelled'"))
...
def downgrade() -> None:
    ...
    op.drop_index('idx_appointment_slot', table_name='appointments', postgresql_where=sa.text("status != 'cancelled'"))
