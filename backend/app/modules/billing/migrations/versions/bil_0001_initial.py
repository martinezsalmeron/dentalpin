...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_invoice_series_clinic_id"), "invoice_series", ["clinic_id"], unique=False
    )
    ...
    op.create_index(
        "idx_invoice_series_history_clinic", "invoice_series_history", ["clinic_id"], unique=False
    )
    op.create_index(
        "idx_invoice_series_history_series", "invoice_series_history", ["series_id"], unique=False
    )
    op.create_index(
        op.f("ix_invoice_series_history_clinic_id"),
        "invoice_series_history",
        ["clinic_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_invoice_series_history_series_id"),
        "invoice_series_history",
        ["series_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_invoices_credit_note_for_id"), "invoices", ["credit_note_for_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_invoice_history_clinic_id"), "invoice_history", ["clinic_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_invoice_items_budget_item_id"), "invoice_items", ["budget_item_id"], unique=False
    )
    op.create_index(
        op.f("ix_invoice_items_catalog_item_id"), "invoice_items", ["catalog_item_id"], unique=False
    )
    op.create_index(
        op.f("ix_invoice_items_clinic_id"), "invoice_items", ["clinic_id"], unique=False
    )
    op.create_index(
        op.f("ix_invoice_items_invoice_id"), "invoice_items", ["invoice_id"], unique=False
    )
    op.create_index(
        op.f("ix_invoice_items_vat_type_id"), "invoice_items", ["vat_type_id"], unique=False
    )
