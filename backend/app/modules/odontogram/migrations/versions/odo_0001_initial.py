...
def upgrade() -> None:
    ...
    op.create_index('idx_odontogram_history_patient', 'odontogram_history', ['patient_id'], unique=False)
    op.create_index('idx_odontogram_history_tooth', 'odontogram_history', ['patient_id', 'tooth_number'], unique=False)
    op.create_index(op.f('ix_odontogram_history_clinic_id'), 'odontogram_history', ['clinic_id'], unique=False)
    op.create_index(op.f('ix_odontogram_history_patient_id'), 'odontogram_history', ['patient_id'], unique=False)


    op.create_table('tooth_records',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('clinic_id', sa.UUID(), nullable=False),
    sa.Column('patient_id', sa.UUID(), nullable=False),
    sa.Column('tooth_number', sa.Integer(), nullable=False),
    ...
    op.create_index('idx_tooth_records_clinic_patient', 'tooth_records', ['clinic_id', 'patient_id'], unique=False)
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.CheckConstraint("(scope = 'global_arch' AND arch IS NOT NULL) OR (scope <> 'global_arch' AND arch IS NULL)", name='ck_treatments_arch_matches_scope'),
    sa.CheckConstraint("arch IS NULL OR arch IN ('upper', 'lower')", name='ck_treatments_arch_value'),
    sa.CheckConstraint("scope IN ('tooth', 'multi_tooth', 'global_mouth', 'global_arch')", name='ck_treatments_scope'),
    ...
    op.create_index(op.f('ix_treatments_catalog_item_id'), 'treatments', ['catalog_item_id'], unique=False)
    ...
    op.create_table('treatment_teeth',
    sa.Column('id', sa.UUID(), nullable=False),
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['tooth_record_id'], ['tooth_records.id'], ),
    ...
    op.create_index('idx_treatment_teeth_tooth_record', 'treatment_teeth', ['tooth_record_id'], unique=False)
    op.create_index('idx_treatment_teeth_treatment', 'treatment_teeth', ['treatment_id'], unique=False)
    op.create_index(op.f('ix_treatment_teeth_tooth_record_id'), 'treatment_teeth', ['tooth_record_id'], unique=False)
    op.create_index(op.f('ix_treatment_teeth_treatment_id'), 'treatment_teeth', ['treatment_id'], unique=False)
