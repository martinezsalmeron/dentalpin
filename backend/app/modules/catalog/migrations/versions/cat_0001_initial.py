...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['parent_id'], ['treatment_categories.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('clinic_id', 'key', name='uq_category_clinic_key')
    )
    op.create_index('idx_treatment_categories_clinic', 'treatment_categories', ['clinic_id'], unique=False)
    op.create_index('idx_treatment_categories_parent', 'treatment_categories', ['parent_id'], unique=False)
    op.create_index(op.f('ix_treatment_categories_clinic_id'), 'treatment_categories', ['clinic_id'], unique=False)
    op.create_index(op.f('ix_treatment_categories_parent_id'), 'treatment_categories', ['parent_id'], unique=False)


    op.create_table('vat_types',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('clinic_id', sa.UUID(), nullable=False),
    sa.Column('names', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
    ...
    op.create_table('treatment_catalog_items',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('clinic_id', sa.UUID(), nullable=False),
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['category_id'], ['treatment_categories.id'], ),
    sa.ForeignKeyConstraint(['clinic_id'], ['clinics.id'], ),
    ...
    op.create_index('idx_catalog_items_active', 'treatment_catalog_items', ['clinic_id', 'is_active'], unique=False)
    op.create_index('idx_catalog_items_category', 'treatment_catalog_items', ['category_id'], unique=False)
    op.create_index('idx_catalog_items_clinic', 'treatment_catalog_items', ['clinic_id'], unique=False)
    op.create_index('idx_catalog_items_vat_type', 'treatment_catalog_items', ['vat_type_id'], unique=False)
    op.create_index(op.f('ix_treatment_catalog_items_category_id'), 'treatment_catalog_items', ['category_id'], unique=False)
    op.create_index(op.f('ix_treatment_catalog_items_clinic_id'), 'treatment_catalog_items', ['clinic_id'], unique=False)
    op.create_index(op.f('ix_treatment_catalog_items_vat_type_id'), 'treatment_catalog_items', ['vat_type_id'], unique=False)


    op.create_table('treatment_odontogram_mappings',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('clinic_id', sa.UUID(), nullable=False),
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['catalog_item_id'], ['treatment_catalog_items.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['clinic_id'], ['clinics.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('catalog_item_id')
    )
    op.create_index('idx_odontogram_mapping_clinic', 'treatment_odontogram_mappings', ['clinic_id'], unique=False)
    op.create_index('idx_odontogram_mapping_type', 'treatment_odontogram_mappings', ['odontogram_treatment_type'], unique=False)
    op.create_index(op.f('ix_treatment_odontogram_mappings_clinic_id'), 'treatment_odontogram_mappings', ['clinic_id'], unique=False)
