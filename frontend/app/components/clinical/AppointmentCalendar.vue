            ...
            <div class="grid grid-cols-8 h-full">
              ...
              >
                <div
                  ...
                  :key="appointment.id"
                  class="absolute left-0.5 right-0.5 rounded overflow-hidden pointer-events-auto select-none shadow-sm"
                  :class="[
                  ...
                  :style="{ ...getAppointmentStyle(appointment), ...getAppointmentColorStyle(appointment) }"
